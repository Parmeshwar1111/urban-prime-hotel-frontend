...
export default class ApiService {
    ...
    static BASE_URL = "https://urbanprimehotel-backend.onrender.com";
    ...
    // ✅ FIXED URL FORMAT (removed line break bug)
    ...
    static async createOrder(amount) {
        const response = await axios.get(
            `${this.BASE_URL}/payments/create-order?amount=${amount}`
        );
        return response.data;
    }
    ...
    static async checkAvailability(roomId, checkInDate, checkOutDate) {
        const response = await axios.get(
            `${this.BASE_URL}/bookings/check-availability/${roomId}?checkInDate=${checkInDate}&checkOutDate=${checkOutDate}`
        );
        return response.data;
    }
}